...
import com.pooial.nntka.wheel.src.kankan.wheel.widget.OnWheelScrollListener;
import com.pooial.nntka.wheel.src.kankan.wheel.widget.WheelView;

import java.util.ArrayList;
import java.util.Random;


public class SlotAdapter extends AppCompatActivity implements OnWheelScrollListener {
...
//        iniWheel(wheelView5,getList());
    ...
    private void iniWheel(WheelView wheelView, ArrayList<Integer> list) {
        wheelView.setViewAdapter(new SlotGameAdapter(this, list));
