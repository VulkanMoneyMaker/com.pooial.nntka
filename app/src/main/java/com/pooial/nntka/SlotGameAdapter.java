...
import com.pooial.nntka.wheel.src.kankan.wheel.widget.adapters.AbstractWheelAdapter;

import java.util.ArrayList;


public class SlotGameAdapter extends AbstractWheelAdapter {
    int MaxNum;
    ...
    public SlotGameAdapter(Context mContext, ArrayList<Integer> list) {
